/*
  IDLF.I
  Modified file of idl.i for yorickvis, written by Hiroshi C. Ito. 2024
...
idl_menu_fun12=" Fun1/2";
idl_menu_fun34=" Fun3/4";
idl_menu_fun56=" Fun5/6";
...
func idl_do_action_menu(LR,but_id){
  ...
  aname=idl_map_menu(LR,but_id);
    ...
    if(aname=="fun3"){"fun3";if(!is_void(fun3))fun3,arg3;}
    if(aname=="fun4"){"fun4";if(!is_void(fun4))fun4,arg4;}
    if(aname=="fun5"){"fun5";if(!is_void(fun5))fun5,arg5;}
    if(aname=="fun6"){"fun6";if(!is_void(fun6))fun6,arg6;}
...
func idl_menu_fun_name(menu_name){
  //menu_name;
  return idl_fun_name(2,where(idl_fun_name(1,)==menu_name))(1);
}
...
func idl_print_menu(void){
  ...
  if(idl_movie==1)idl_print_but," Movie:on\n /Encode","red",idl_menu_id("switch_movie"),col0="black";
   ...
   idl_print_but,idl_menu_fun12,"blue",idl_menu_id("fun1"),col0="black";
   idl_print_but,idl_menu_fun34,"blue",idl_menu_id("fun3"),col0="black";
   idl_print_but,idl_menu_fun56,"blue",idl_menu_id("fun5"),col0="black";
...
func idl_make_movie(void){
   ...
   if(idl_movie_eps==1){
    ...
    cd,Y_DIR+"buf";
     ...
     system,swrite(format="../ps2mp4ps %d %d %s",300,idl_movie_size,"test.mp4");
     cd,cwd;
...
func idl(dp,count,rot=,stop=,fun0=,fun1=,fun2=,fun3=,fun4=,fun5=,fun6=,arg0=,arg1=,arg2=,arg3=,arg4=,arg5=,arg6=,rot_hist=)
...
*/
{
  extern idl_fun0,idl_init,idl_win_style,idl_flag_stop,idl_count,idl_count_movie;
