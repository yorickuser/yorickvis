...
/* ------------------------------------------------------------------------ */
pl3tree_rgb=0;
func pl3tree(nverts, xyzverts, values, plane, cmin=, cmax=,ecol=,mypal=)
/* DOCUMENT pl3tree(nverts, xyzverts, values, plane, cmin=, cmax=,ecol=,mypal=)
 ...
 */
{
  ...
  if (_draw3) {
    ...
    local x,y,z;
    local nverts, xyzverts, values, list, vlist, cmin, cmax,ecol,mypal;
  ...
  leaf= _lst(_lst(nverts, xyzverts, values, cmin, cmax,ecol,mypal));
...
func _pl3leaf(leaf, not_plane)
{
  /* avoid overhead of local variables for _pl3tree and _pl3leaf */
  extern x,y,z;
  extern nverts, xyzverts, values, list, vlist,ecol,mypal;
  ...
  plfp, values,y,x,nverts, edges=edges,ecolor=ecol,legend=string(0);
...
func _pl3tree_accum(item)
{
  ...
  extern nv, vv, xx, yy, zz, cmin, cmax, ecol,mypal;
