...
# $Id: boxed2.gs,v 1.1 1993/08/27 17:08:43 munro Exp $
...
default = {
 ...
 horiz= { 
      ...
      nDigits= 3,  gridLevel= 1,  flags= 00000, 
      tickOff= 0.0007,  labelOff= 0.010,
      tickLen= { 0.006, 0.003, 0.003, 0.0027, 0.0018 },
    ...
    vert= {
      nMajor= 5.0,  nMinor= 25.0,  logAdjMajor= 1.2,  logAdjMinor= 1.2,
      nDigits= 4,  gridLevel= 1,  flags= 00000,
...
#viewport= { 0.1757, 0.25, 0.4257, 0.8643 }
#viewport= { 0.35, 0.6143, 0.4257, 0.8643 }

# The first coordinate system has left ticks and labels
system= {
  legend= "Panel 1",
  viewport= { 0.1757, 0.25, 0.4257, 0.6 },	
  ticks= { horiz= { flags= 00000 }, vert= { flags= 00000 } }}

# The second coordinate system has right ticks and labels
system= {
  legend= "Panel 2",
  viewport= { 0.1757, 0.25, 0.6, 0.8643 },	
  ticks= { horiz= { flags= 00000 }, vert= { flags= 00000 } }}
 
# The third coordinate system has right ticks and labels
system= {
  legend= "Panel 3",
  viewport= { 0.25, 0.6143, 0.4257, 0.6},	
  ticks= { horiz= { flags= 00000 }, vert= { flags= 00000 } }}


# The fourth coordinate system has right ticks and labels
system= {
  legend= "Panel 4",
  viewport= { 0.25, 0.6143, 0.6, 0.8643 },	
  ticks= { horiz= { flags= 00000 }, vert= { flags= 00000 } }}
